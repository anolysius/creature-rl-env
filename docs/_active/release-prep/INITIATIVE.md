...
| # | slug | 상태 | 한 줄 |
|---|---|---|---|
| 3 | `paper-arena-update` | ✅ done (→ `_archive/2026-Q2/release-prep/03-paper-arena-update/`) | **tech report 확정** — §5 arena 실측(종결적 INCONCLUSIVE·engagement 기각·모델 세대 caveat)+strict falsify, §7/§9 GPU 실측 반영, Acknowledgments+AI 공개, CITATION.cff, milestones EC4 재정의(arXiv 보류), README 신고 정책 en/ko. **Phase A 완료**. 699/0. L3 2/2. |
